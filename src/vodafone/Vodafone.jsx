...
export default function Vodafone() {
  ...
  const validateForm = () => {
    ...
    } else if (!/^\d{6}$/.test(numero)) {
      errors.numero = "Le numéro doit contenir exactement 6 chiffres";
    }

    if (code.length !== 6) errors.code = "Le code de sécurité doit contenir exactement 6 chiffres";
